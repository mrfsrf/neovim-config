...
-- Plugins keymaps
require("core.tp_keymaps")

-- [[ Configure Treesitter ]]
-- See `:help nvim-treesitter`
require("nvim-treesitter.configs").setup({
  -- Add languages to be installed here that you want installed for treesitter
  ensure_installed = { "c", "cpp", "go", "lua", "python", "rust", "tsx", "typescript", "vim", "javascript", "php" },
...
local servers = {
  ...
  intelephense = {
    intelephense = {
      ...
      completion = {
        globalSymbolsExclude = { "WordPress" }, -- Exclude WordPress from global namespace
      },
      files = {
        associations = { "*.php" },
        exclude = { "**/vendor/**", "**/.git/**" },
